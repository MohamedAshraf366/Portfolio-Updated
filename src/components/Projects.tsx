...
import project47 from "../images/Payload - Test file generator.jpg";
...
const allProjects: Project[] = [
  ...
  { id: 47, img: project47, url: "https://test-file-generator-silk.vercel.app/", title: "Payload Test File Generator",  tags: ["Next.js", "Tailwind"], category: "Next" },
  ...
  { id: 34, img: project34, url: "https://car-dealership-xi-ruddy.vercel.app/en", title: "AutoElite - Car Dealership",  tags: ["Next.js", "Tailwind"], category: "Next" },
  ...
  { id: 29, img: project29, url: "https://legal-ledger-craft.vercel.app/", title: "Adalah Law Firm and Legal Consultations", tags: ["React.js", "Tailwind"], category: "React" },
  { id: 28, img: project28, url: "https://qr-creator-delta.vercel.app/en", title: "QR Creator", tags: ["React", "Tailwind"], category: "React" },
  { id: 27, img: project27, url: "https://currency-streamline-main-5dqbrpg55-moahmed-ashrafs-projects.vercel.app/", title: "Currency Stream", tags: ["React", "Tailwind"], category: "React" },
  ...
  { id: 15, img: project15, url: "https://limitless-nextjs-fveaaaezp-moahmed-ashrafs-projects.vercel.app/", title: "Limitless", tags: ["Next.js", "Tailwind"], category: "Next" },
  ...
  { id: 40, img: project40, url: "https://mohamedashraf366.github.io/Rocker-For-Furnature/", title: "Rocker For Furniture", tags: ["HTML", "JS"], category: "HTML/CSS" },
  ...
  { id: 6, img: project6, url: "https://mohamedashraf366.github.io/Project6/", title: "Project Six", tags: ["Bootstrap"], category: "HTML/CSS" },
  { id: 7, img: project7, url: "https://mohamedashraf366.github.io/Project7/", title: "Project Seven", tags: ["Bootstrap"], category: "HTML/CSS" },
...
const ProjectCard: React.FC<{ project: Project; index: number }> = React.memo(({ project, index }) => {
  ...
  return (
    ...
    >
      <div className="aspect-video overflow-hidden bg-dark-800 relative">
        <motion.img
          src={project.img}
          alt={project.title}
          loading="lazy"
  ...
  return (
    <section id="projects" className="py-28 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6">
            ...
            <button
              ...
              className={`px-5 py-2 rounded-full text-sm font-medium font-body transition-all duration-300 ${
                filter === f
                  ...
                  : "border border-white/10 text-slate-400 hover:border-white/20 hover:text-white hover:bg-white/5"
              }`}
            >
              {f}
            </button>
        ...
        {/* Grid */}
        <motion.div layout className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5" style={{ perspective: "1200px" }}>
