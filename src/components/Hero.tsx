...
const Hero: React.FC = () => {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center grid-bg noise-bg overflow-hidden">
      {/* Background orbs */}
      <div className="absolute top-1/4 -left-40 w-96 h-96 rounded-full bg-cyan-500/10 blur-[120px] pointer-events-none animate-pulse-glow" />
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            <motion.div variants={itemVariants}>
              <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-cyan-500/30 bg-cyan-500/10 text-cyan-400 text-sm font-mono backdrop-blur-sm">
                <Sparkles size={14} className="animate-pulse" />
                Available for work
              </span>
            </motion.div>

            <motion.h1 variants={itemVariants} className="font-display font-bold text-5xl md:text-7xl leading-tight text-white">
              Hi, I'm{" "}
            ...
            <motion.div variants={itemVariants} className="flex flex-wrap gap-4">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="group relative px-8 py-3.5 rounded-full font-medium font-body bg-gradient-to-r from-cyan-500 to-violet-600 text-white hover:shadow-2xl hover:shadow-cyan-500/30 transition-all duration-300 hover:scale-105 active:scale-95 overflow-hidden"
              >
              ...
              <a
                href="#projects"
                className="px-8 py-3.5 rounded-full font-medium font-body border border-white/10 text-slate-300 hover:border-cyan-500/50 hover:text-white hover:bg-white/5 transition-all duration-300 backdrop-blur-sm"
              >
                View Projects
              </a>
              <a
                ...
                download
                className="group px-8 py-3.5 rounded-full font-medium font-body border border-amber-500/30 text-amber-400 hover:bg-amber-500/10 hover:border-amber-500/50 hover:shadow-lg hover:shadow-amber-500/10 transition-all duration-300 hover:scale-105 active:scale-95 backdrop-blur-sm"
              >
            ...
            <motion.div variants={itemVariants} className="flex gap-8 pt-4">
              {[
                ...
                <div key={stat.label} className="flex flex-col group cursor-default">
                  <span className="font-display font-bold text-3xl gradient-text group-hover:scale-110 transition-transform inline-block">{stat.value}</span>
          ...
          >
            ...
            <motion.div
              ...
              className="absolute inset-0 m-auto w-[400px] h-[400px] md:w-[480px] md:h-[480px] rounded-full border border-dotted border-amber-500/10"
            />

            {/* Glow */}
            <div className="absolute inset-0 m-auto w-64 h-64 rounded-full bg-cyan-500/20 blur-3xl animate-pulse-glow" />
            ...
            >
              <div className="w-72 h-72 md:w-80 md:h-80 rounded-full overflow-hidden border-2 border-cyan-500/30 shadow-2xl shadow-cyan-500/20 relative">
                <img
                  src={heroImg}
                  alt="Mohamed Ashraf"
                  className="w-full h-full object-cover object-top"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-cyan-500/10 via-transparent to-violet-500/10 pointer-events-none" />
              </div>
              ...
              <motion.div
                ...
                className="absolute -bottom-4 -right-4 glass rounded-2xl px-4 py-2 border border-cyan-500/20 shadow-lg shadow-cyan-500/10"
                style={{ transformStyle: "preserve-3d" }}
              >
              ...
              <motion.div
                ...
                whileHover={{ scale: 1.1, rotate: -5 }}
                className="absolute -top-4 -left-4 glass rounded-2xl px-4 py-2 border border-violet-500/20 shadow-lg shadow-violet-500/10"
                style={{ transformStyle: "preserve-3d" }}
              >
                <span className="text-xs text-slate-400 font-mono">status</span>
                <p className="text-xs text-violet-400 font-medium mt-0.5 flex items-center gap-1">
