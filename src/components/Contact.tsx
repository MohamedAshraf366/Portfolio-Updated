...
import { GitHubIcon, LinkedInIcon, FacebookIcon, WhatsAppIcon } from "./SocialIcons";

const contactInfo = [
  { icon: Mail, label: "Email", value: "mohamedashraf366@gmail.com", href: "mailto:mohamedashraf366@gmail.com" },
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          ...
          >
            ...
            <div className="space-y-4">
              {contactInfo.map((item, i) => (
                ...
                >
                  <div className="w-12 h-12 rounded-xl bg-cyan-500/10 border border-cyan-500/20 flex items-center justify-center text-cyan-400 group-hover:scale-110 group-hover:rotate-6 transition-all duration-300">
                    <item.icon size={20} />
                  </div>
            ...
            <div>
              ...
              <div className="flex gap-3">
                {[
                  { icon: GitHubIcon, href: "https://github.com/MohamedAshraf366", label: "GitHub" },
                  { icon: LinkedInIcon, href: "https://www.linkedin.com/in/mohamed-ashraf-497a13170", label: "LinkedIn" },
                  { icon: FacebookIcon, href: "https://www.facebook.com/mohamed.ashraf.791060/", label: "Facebook" },
                  { icon: WhatsAppIcon, href: "https://wa.me/201111166832", label: "WhatsApp" },
                ].map((s) => (
                  <a
                    key={s.href}
                    href={s.href}
                    ...
                    rel="noreferrer"
                    aria-label={s.label}
                    className="w-11 h-11 rounded-full glass border border-white/10 flex items-center justify-center text-slate-400 hover:text-white hover:border-cyan-500/40 hover:bg-cyan-500/10 hover:scale-110 hover:-translate-y-1 transition-all duration-300"
                  >
                    <s.icon size={18} />
                  </a>
                ))}
          ...
          <motion.form
            ...
            className="glass rounded-3xl p-8 border border-white/5 space-y-5 relative overflow-hidden"
          >
            {/* Form glow */}
            <div className="absolute -top-20 -right-20 w-40 h-40 bg-cyan-500/5 rounded-full blur-3xl pointer-events-none" />
            <div className="absolute -bottom-20 -left-20 w-40 h-40 bg-violet-500/5 rounded-full blur-3xl pointer-events-none" />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 relative z-10">
              <div className="flex flex-col gap-2">
                ...
                <input
                  ...
                  className="bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-slate-600 font-body focus:outline-none focus:border-cyan-500/50 focus:bg-white/8 focus:shadow-lg focus:shadow-cyan-500/5 transition-all duration-300"
                />
              </div>
              <div className="flex flex-col gap-2">
            ...
            <div className="flex flex-col gap-2 relative z-10">
              ...
              <textarea
                ...
                className="bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-slate-600 font-body focus:outline-none focus:border-cyan-500/50 focus:bg-white/8 focus:shadow-lg focus:shadow-cyan-500/5 transition-all duration-300 resize-none"
              />
            </div>

            <button
              type="submit"
              className="w-full relative flex items-center justify-center gap-2 px-6 py-4 rounded-xl font-medium font-body bg-gradient-to-r from-cyan-500 to-violet-600 text-white hover:shadow-2xl hover:shadow-cyan-500/30 transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] overflow-hidden group z-10"
            >
