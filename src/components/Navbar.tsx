  ...
  return (
    <motion.nav
      ...
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
        scrolled ? "glass border-b border-cyan-500/10 py-3 shadow-lg shadow-cyan-500/5" : "py-5"
      }`}
    >
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        ...
        {/* CTA + Social + CV Download */}
        <div className="hidden md:flex items-center gap-4">
          {/* Social icons */}
          <div className="hidden md:flex items-center gap-3">
            <a href="https://www.facebook.com/mohamed.ashraf.791060/" target="_blank" rel="noreferrer" aria-label="Facebook"
            ...
            <a href="https://www.linkedin.com/in/mohamed-ashraf-497a13170" target="_blank" rel="noreferrer" aria-label="LinkedIn"
              className="w-8 h-8 rounded-full border border-white/10 flex items-center justify-center text-slate-400 hover:text-white hover:border-cyan-400/50 hover:bg-cyan-400/10 transition-all duration-300">
              <LinkedInIcon size={14} />
            </a>
            <a href="https://github.com/MohamedAshraf366" target="_blank" rel="noreferrer" aria-label="GitHub"
              className="w-8 h-8 rounded-full border border-white/10 flex items-center justify-center text-slate-400 hover:text-white hover:border-cyan-400/50 hover:bg-cyan-400/10 transition-all duration-300">
              <GitHubIcon size={14} />
            </a>
          </div>
          ...
          <a
            ...
            download
            className="flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium font-body border border-amber-500/30 text-amber-400 hover:bg-amber-500/10 hover:border-amber-500/50 hover:shadow-lg hover:shadow-amber-500/10 transition-all duration-300 hover:scale-105"
          >
            <Download size={14} />
            CV
          </a>
          ...
          >
            <div className="px-6 py-6 flex flex-col gap-5">
              ...
              <a
                ...
                className="flex items-center justify-center gap-2 px-5 py-2 rounded-full text-sm font-medium border border-amber-500/30 text-amber-400 hover:bg-amber-500/10 transition-all"
              >
                <Download size={14} />
                Download CV
              </a>
